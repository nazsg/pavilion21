<template>
  <div class="setmenus">
    ...
    <div class="page_container">
      ...
      <table3Col title="Set Menu" :menus="all_menus.filter(m=>m.category=='set_menu')" />
...
export default {
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Our set menus - Menu A, Menu B, Menu C, Menu D, Menu E' }
    ]
  },
  data() {
    return {
